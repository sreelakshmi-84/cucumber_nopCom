...
public class RegistrationPage {
    ...
    public void registraion(WebDriver driver){

        driver.get("https://demo.nopcommerce.com/");

    }
    public void clickOnRegistraionlink(WebDriver driver){
        driver.findElement(By.linkText("Register")).click();

    }

    public void checkForRegistrationText(WebDriver driver){
    ...
    public void enterDetails(WebDriver driver, String fName, String lName, String email, String pWord){
    ...
    public void successfulMessage(WebDriver driver){
